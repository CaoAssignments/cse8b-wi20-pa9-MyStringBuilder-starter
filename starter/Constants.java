public class Constants {
    ...
    public static final String FROM_DELETE_STARTINDEX_ENDINDEX = "delete(int, int)";
    public static final String FROM_SUBSTRING_STARTINDEX = "substring(int)";
    public static final String FROM_SUBSTRING_STARTINDEX_ENDINDEX = "substring(int, int)";
